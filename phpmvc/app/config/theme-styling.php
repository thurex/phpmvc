...
return [
    ...
    'views' => [
        [
            ...
            'data'      => [
                'siteTitle'  => "Thures egna sida i PHPMVC",
                'siteTagline'    => "Rather a line php than a line in the nose, stay cool and stay clean",
                ],
            'sort'      => -1
        ],
        //Main view
        [
            'region' => 'main',
            'template' => 'styling/page',
            'data' => [],
            'sort' => -1
        ],
        ['region'   => 'footer', 'template' => 'styling/footer', 'data'  => [], 'sort'   => -1],
        //Navbar
        [
            'region' => 'navbar',
            'template' => [
